...
from graphics_arts.start_game_banner import run_screensaver
...
def defence(char_name: str, char_class: str) -> str:
    ...
    return f'{char_name} не применил блокировку удара'
